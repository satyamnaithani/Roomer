...
<div class="jumbotron">
<h1 align="center">Roomer-Enterprise DashBoard</h1>
<p align="center">Upload quality rooms On Roomer and Get assured Increment In  Bussiness</p> 
</div>
...
String sql1 = "select * from booked_rooms where partnerName = '"+(String)session.getAttribute("partnerName")+"'";
...
<div class="container">
    ...
    <a href="freeRoom.jsp?hotelName=<%out.println(rslt.getString("hotelName"));%>&roomNo=<%out.println(rslt.getString("roomNo"));%>"class="btn btn-success">Free Room</a>
